    ...
    <div class="wrapper">
        ...
        <div class="main_container">
            <div class="item" style="overflow-y:auto;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $murid['nokpmurid']; ?></td>
                        ...
                        <td><a href="murid_kemaskini.php?nokpmurid=<?php echo $murid['nokpmurid'];?>"><i class="fas fa-edit"></i></a></td>
                        <td><a href="murid_padam.php?nokpmurid=<?php echo $murid['nokpmurid'];?>"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
            ...
            <div class="item2">
                <h3>Tindakan</h3>
                <ul>
                    <li><a href="murid_senarai.php" id="first" class="active">
